...
//}
//void docFile(DoThi& g) {
//	FILE* f = fopen("dothivohuong7.txt", "rt");
//	if (f == NULL) {
//		printf("\nKhong tim thay file");
//	}
//	else {
...
//}
//void xuatBangChiPhi(DoThi g, Nhan bangChiPhi[vmax][vmax]) {
//	printf("\nBang mo ta thuat toan Prim tim cac duong truyen co so tien thue bao nho nhat: \n");
//	for (int i = 1; i <= g.n; i++) {
//		printf("\t %c", 64 + i);
//	}
//	for (int i = 0; i <= g.n; i++) {
...
//}
//void xuatCayKhung(DoThi g, Nhan bangChiPhi[vmax][vmax]) {
//	printf("\nDanh sach cac canh truyen co so tien thue bao nho nhat: \n");
//	int i = 2;
//	while (i <= g.n) {
