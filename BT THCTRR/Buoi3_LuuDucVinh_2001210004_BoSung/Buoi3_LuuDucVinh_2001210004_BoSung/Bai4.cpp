...
//}
//void docFile(DoThi& g) {
//	FILE* f = fopen("dothivohuong4.txt", "rt");
//	if (f == NULL) {
//		printf("\nKhong tim thay file");
//	}
//	else {
...
//void xuatCayKhung(DanhSachCanh dsck) {
//	float chiPhi = 0;
//	for (int i = 0; i < dsck.n; i++) {
//		printf("\n%d - %d: %.1f", dsck.data[i].u + 1, dsck.data[i].v + 1, dsck.data[i].w);
//		chiPhi += dsck.data[i].w;
//	}
//	printf("\nDo tin cay lon nhat cua cay khung la: %.1f", chiPhi);
//}