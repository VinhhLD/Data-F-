...
//	else
//		printf("\nDo thi co huong");
//	printf("\nSo quan va duong di cua ban do:");
//	for(int i=1;i<=g.n;i++)
//	{
//		printf("\n");
//		for(int j=1;j<=g.n;j++)
...
//{
//	printf("\nDuong di cua ban do nhu sau: \n");
//	for(int i=1;i<=soCanh;i++)
//		printf("\t(%d %d)",c[i].u,c[i].v);
//}
//void xayDungCayKhung_BFS(DoThi g,Canh c[], int& soCanh)
//{
//	for(int u=1;u<=g.n;u++)
//	{
//		for(int v=1;v<=g.n;v++)
...
//	Canh c[100];
//	int soCanh=0;
//	xayDungCayKhung_BFS(g,c,soCanh);
//	getch();
//}