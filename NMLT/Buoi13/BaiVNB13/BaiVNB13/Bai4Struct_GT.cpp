...
//	char diachi [300];
//};
//void docfile (FILE *&f, NV dsnv [], int &n);
...
//	printf("2.Them vao 1 nhan vien\n");
//	printf("3.Tim nhan vien theo ma so\n");
//	printf("4.Tim 1 nhan vien theo ten\n");
//	printf("5.In ra bang luong cua cac nhan vien theo thu tu giam dan\n");
//	printf("6.Xoa 1 nhan vien\n");
...
//void docfile (FILE *&f, NV dsnv [], int &n)
//{
//	f = fopen("dataB4.txt", "rt");
//	fscanf(f, "%d", &n);
//	for (int i = 0; i < n; i++)
//	{
//		fscanf(f, "%d", &dsnv[i].maso);
//		fscanf(f, "%s ", dsnv[i].ho);
//		fgets(dsnv[i].ten, 15, f);
//		fscanf(f, "%d ", &dsnv[i].ns.d);
//		fscanf(f, "%d", &dsnv[i].ns.m);
//		fscanf(f, "%d", &dsnv[i].ns.y);
//		fscanf(f, "%d", &dsnv[i].ngayct.d);
//		fscanf(f, "%d", &dsnv[i].ngayct.m);
//		fscanf(f, "%d", &dsnv[i].ngayct.y);
//		fscanf(f, "%d ", &dsnv[i].luong);
//		fgets(dsnv[i].noisinh, 300, f);
//		fgets(dsnv[i].diachi, 300, f);
//	}
//}
//void nhapntn (date &ntn)
//{
