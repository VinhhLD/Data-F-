...
//
////Cau 9 
//void Xoayvongtrai(int a[][MAX], int m, int n, int &k)
//{
//	while(k--)
//	{
//		int temp[MAX];
...
//int main()
//{
//	int a[MAX][MAX], e[MAX][MAX], c[MAX][MAX], d[MAX][MAX], chon, n, k, m, aRow, aCol;
//	do
//	{
//		printf("\t\t\t\t\t\t\t=====================MENU====================\n");
...
//		printf("\t\t\t|9.Tu A da cho tao ra va xuat ra mot ma tran F duoc dich xoay vong cac cot theo truc dung voi chieu tu trai sang phao k lan.|\n");
