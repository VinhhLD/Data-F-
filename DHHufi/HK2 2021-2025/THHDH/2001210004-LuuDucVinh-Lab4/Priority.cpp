...
//{
//	char pid[11];
//	int douutien, tdden, tgxuly, tgdapung, tgcho, tghoanthanh, tdbatdauxuly, tdhoanthanh;
//};
...
//		printf("Nhap do uu tien [%d]: ", i); scanf_s("%d", &p[i].douutien);
//		p[i].tdden = 0;
//	}
//}
//void XuatTT (Process p[], int n)
